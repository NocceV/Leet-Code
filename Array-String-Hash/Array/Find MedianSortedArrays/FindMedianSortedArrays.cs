   ...
   public double FindMedianSortedArrays(int[] nums1, int[] nums2)
    {
        ...
        //Create the last 2 values, prev and current, prev represents the last value that will serve if the total length is par
        //Inicialize the while loop, that goes only the half
            //IF ponteir1 is less than n and the value inside the array is lass tha value i nthe array2, we put current = nums1[ponteir1]
