# Intuition
Usar ponteiros para comparar todos os valores possiveis

# Approach
Usar ponteiros esquerda e direita, iterando dentro de um for loop para comparar todos os valores possiveis da soma de tres elementos no array.
